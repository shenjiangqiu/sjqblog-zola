...
the code will create a tcp server, and the client can connect to the server and send message to the server. the server will broadcast the message to all the clients.
